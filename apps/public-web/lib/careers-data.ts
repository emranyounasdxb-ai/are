...
export const careersCopy: Readonly<Record<Locale, CareersCopy>> = {
  ...
  ar: {
    ...
    metaDescription: "تعرّف إلى وظائف ALIYAS Real Estate الموثقة أو أرسل طلباً مهنياً عاماً آمناً بالعربية أو الإنجليزية.",
    breadcrumb: "الوظائف",
    ...
    journey: { eyebrow: "رحلة التوظيف", title: "مسار واضح لتقديم الطلب", text: "تُرسل الطلبات بأمان لمراجعتها من مستخدمي إدارة ALIYAS والموارد البشرية المخولين.", items: [{ title: "التجهيز", text: "أكمل التحقق من الحقول وراجع المعلومات التي تنوي مشاركتها." }, { title: "الإرسال الآمن", text: "يتم التحقق من الطلب والسيرة الذاتية الخاصة وتخزينهما خارج المسارات العامة." }, { title: "مراجعة الدور", text: "قد يُنظر في الطلب مقابل وظيفة مفتوحة أو احتياج مستقبلي مناسب، من دون وعد بنتيجة." }, { title: "التواصل مع المرشح", text: "يجب أن تُدار أي مقابلة أو خطوة مستقبلية من خلال إجراء توظيف معتمد." }] },
    ...
    privacy: { eyebrow: "إشعار بيانات المتقدم", title: "تبقى سيرتك الذاتية خاصة.", text: "لا تتاح معلومات الطلب إلا لمستخدمي إدارة ALIYAS والموارد البشرية المخولين. ويمكن ضبط مدة الاحتفاظ بعد اعتماد سياسة المالك.", points: ["تُخزن بيانات النموذج والسيرة الذاتية بشكل خاص لمراجعة الطلب.", "لا تُدرج وثائق الهوية أو البيانات المصرفية أو معلومات شخصية حساسة لا حاجة لها.", "الموافقة التسويقية اختيارية ومنفصلة عن تقديم الطلب."] },
