...
export const siteCopy: Readonly<Record<Locale, SiteCopy>> = {
  en: {
    ...
    pages: {
      ...
      contact: {
        description:
          "Share the outline of what you are looking for. This local preview validates your enquiry without sending it anywhere.",
        eyebrow: "Start a conversation",
        metaDescription:
          "Prepare a property enquiry for ALIYAS Real Estate through a safe frontend-only preview form.",
    ...
    contact: {
      ...
      previewNote: "Preview only — this form does not transmit or store your information.",
      submit: "Review enquiry",
      success: "Your preview enquiry is ready. Secure enquiry routing will be connected in a later approved phase; nothing was sent.",
  ...
  ar: {
    ...
    pages: {
      ...
      contact: {
        description:
          "شارك الخطوط العامة لما تبحث عنه. تتحقق هذه المعاينة المحلية من استفسارك من دون إرساله إلى أي جهة.",
        eyebrow: "ابدأ حواراً",
        metaDescription: "جهّز استفسارك العقاري مع ALIYAS Real Estate عبر نموذج معاينة آمن يعمل في الواجهة فقط.",
    ...
    contact: {
      ...
      previewNote: "معاينة فقط — لا يرسل هذا النموذج معلوماتك ولا يخزنها.",
      submit: "راجع الاستفسار",
      success: "أصبحت معاينة استفسارك جاهزة. سيتم ربط مسار آمن للاستفسارات في مرحلة لاحقة معتمدة؛ لم يتم إرسال أي شيء.",
