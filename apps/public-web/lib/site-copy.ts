  ...
  ar: {
    ...
    pages: {
      properties: {
        ...
        metaDescription:
          "حدّد موجز بحثك عن عقار في الإمارات مع علياس العقارية. سيظهر المخزون المباشر فقط بعد ربط بيانات معتمدة.",
        metaTitle: "العقارات | علياس العقارية",
      ...
      communities: {
        ...
        metaDescription: "استكشف مسارات آمنة للتعرّف إلى مجتمعات الإمارات مع علياس العقارية.",
        metaTitle: "المجتمعات | علياس العقارية",
      ...
      "off-plan": {
        ...
        metaDescription: "تعرّف إلى مسار عام ومدروس لاكتشاف العقارات على المخطط مع علياس العقارية.",
        metaTitle: "على المخطط | علياس العقارية",
        title: "انتقل من الاهتمام الأولي إلى استكشاف واعٍ.",
      },
      about: {
        description:
          "تعمل علياس العقارية على صياغة مسار ثنائي اللغة أكثر وضوحاً، من النية الأولى إلى حوار عقاري مدروس.",
        eyebrow: "نهجنا المقصود",
        metaDescription: "تعرّف إلى نهج تجربة الاكتشاف الثنائية اللغة لدى علياس العقارية.",
        metaTitle: "من نحن | علياس العقارية",
      ...
      contact: {
        ...
        eyebrow: "ابدأ حواراً",
        metaDescription: "أرسل استفساراً عقارياً آمناً إلى علياس العقارية بالإنجليزية أو العربية.",
        metaTitle: "تواصل معنا | علياس العقارية",
    ...
    contact: {
      ...
      intro: "شارك فقط المعلومات اللازمة ليتمكن مستخدمو إدارة علياس العقارية المخولون من مراجعة استفسارك والرد عليه.",
