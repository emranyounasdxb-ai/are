...
const arPages: Record<PageSlug, PageRichCopy> = {
  ...
  about: {
    intro: { eyebrow: "من نحن", title: "مسار أوضح لاكتشاف العقارات.", text: "تطوّر علياس العقارية تجربة عقارية ثنائية اللغة في الإمارات، تبدأ بهدف العميل وتعرض المعلومات بصدق مع توفر الإمكانات المعتمدة." },
    sections: [
    ...
    faq: { eyebrow: "أسئلة من نحن", title: "فهم تجربة علياس العقارية الحالية", items: [
  ...
  contact: {
    ...
    sections: [
      ...
      { eyebrow: "ما الذي يحدث لاحقاً", title: "يدخل استفسارك إلى قائمة مراجعة آمنة.", text: "يمكن لمستخدمي إدارة علياس العقارية المخولين مراجعة الطلب وتحديث حالته الداخلية.", items: [
