...
export type PublicProject = { id:string;slug:string;emirate:string;developer:{slug:string;name:string};area:{slug:string;name_en:string;name_ar:string;emirate:string};availability_status:string;construction_status:string;handover_quarter:string|null;handover_year:number|null;original_handover_value?:string|null;handover_verification?:string;property_types:string[];bedroom_options:string[];unit_types?:Array<{label:string;display_order:number}>;size_min?:string|number|null;size_max?:string|number|null;size_unit?:string|null;size_ranges?:Array<{property_type:string;minimum:number;maximum:number}>;down_payment_percentage?:string|number|null;payment_plan?:{is_complete:boolean;milestones:Array<{sequence:number;stage:string;label:string|null;percentage:string|number|null}>}|null;amenities?:Array<{label:string;display_order:number}>;nearby_places?:Array<{name:string;travel_time_minutes:number|null;display_order:number}>;media?:Array<{id:string;category:string;url:string;alt:string|null;width:number|null;height:number|null}>;official_name:string;short_summary:string;full_description:string;cta:string };
export type CandidateProjectPreview = { candidate_id:string;locale:Locale;project_name:string;developer:{name:string};emirate:string;area:string;overview:string|null;property_types:string[];unit_types:string[];bedrooms:string[];size_min:number|null;size_max:number|null;size_unit:string|null;size_ranges:Array<{property_type:string;minimum:number;maximum:number}>;down_payment_percentage:number|null;payment_plan:string|null;payment_milestones:Array<{sequence:number;stage:string;percentage:number|null}>;handover_quarter:string|null;handover_year:number|null;handover_verification:string;availability_status:string;construction_status:string;amenities:string[];nearby_places:Array<{name:string;travel_time_minutes:number|null}>;media:ProjectPreviewMedia[];has_cover:boolean };
