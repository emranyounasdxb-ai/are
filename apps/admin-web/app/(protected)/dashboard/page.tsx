...
import { BriefcaseBusiness, Building2, Factory, FileText, Inbox, Plus, Users } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return <section><AdminPageHeader eyebrow="Overview" title="Dashboard" description="Live overview of your content and enquiries."/>
    ...
    <section className="quick-actions" aria-labelledby="quick-actions-title"><div><p className="eyebrow">Create</p><h2 id="quick-actions-title">Quick actions</h2></div><div><Link href="/properties/new"><Plus aria-hidden size={16}/>Add Property</Link><Link href="/developers/new"><Plus aria-hidden size={16}/>Add Developer</Link><Link href="/insights/new"><Plus aria-hidden size={16}/>Create Insight</Link><Link href="/careers/jobs/new"><Plus aria-hidden size={16}/>Add Job</Link></div></section>
  </section>;
}
