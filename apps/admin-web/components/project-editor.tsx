...
const initialValues = (): Values => ({ slug: "", emirate: "", developer_id: "", area_id: "", status: "draft", workflow_status: "draft", availability_status: "coming-soon", construction_status: "not-confirmed", handover_quarter: "", handover_year: "", original_handover_value: "", size_min: "", size_max: "", size_unit: "", down_payment_percentage: "", down_payment_source_value: "", latitude: "", longitude: "", last_verified_at: "", priority: "", featured: false, display_order: 0, internal_notes: "", property_types: [], bedroom_options: [], unit_types: [], amenities: [], nearby_places: [], translations: { en: emptyTranslation(), ar: emptyTranslation() }, sources: [], payment_raw: "", payment_source_index: 0, payment_complete: false, payment_verified_at: "", milestones: [], media: [] });
